 ...
 *
 * ‏`geocodeAfula` שמעל נשארת לעפולה בלבד: יצירת נכס ועדכון כתובת בוואטסאפ
 * בוחרים ביניהן לפי העיר (`geocodeForProperty` ב-agent.ts), כך שבעפולה
 * הפין ממשיך להגיע מהקבועים שבקוד גם כשהמסד אינו עונה.
 *
