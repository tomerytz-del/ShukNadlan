...
comment on function public.notification_push_due_agents() is
  'הסוכנים שמותר לשלוח להם/ן עכשיו הודעת וואטסאפ על התראות: ערוץ דלוק עם מספר, מחוץ לשעות השקט, בתוך התקרה היומית ואחרי מרווח הקיבוץ. אינה בודקת אם יש התראה — זה החלק היקר ונשאר ב-claim.';
