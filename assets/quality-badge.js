...
(function (global) {
  ...
  var CSS = [
    ...
    '  cursor:pointer;font:inherit;color:inherit;vertical-align:middle;line-height:1;border-radius:0}',
    ...
    '.qb-modal{position:relative;width:min(560px,100%);max-height:88vh;overflow-y:auto;background:#f8faff;',
    '  border-radius:0;box-shadow:0 24px 60px rgba(8,18,32,.4);',
    '  font-family:Heebo,system-ui,sans-serif;color:#0d1b3d;direction:rtl;text-align:right;',
    ...
    '.qb-head{background:linear-gradient(150deg,#0E2340,#0e2a6b 62%,#2A4E77);color:#fff;',
    '  padding:22px 22px 20px;border-radius:0 22px 0 0;display:flex;align-items:center;gap:15px}',
    ...
    '.qb-list li{position:relative;padding:10px 40px 10px 12px;background:#fff;border:1px solid #eef1f8;',
    '  border-radius:0;font-size:.82rem;line-height:1.5;color:#4a5578}',
    ...
    '  border-radius:0;font-weight:800;font-size:.88rem;text-decoration:none;border:none;cursor:pointer}',
    '.qb-cta-primary{background:linear-gradient(120deg,#12294A,#0e2a6b 70%);color:#fff;',
    '  box-shadow:0 6px 16px rgba(18,41,74,.24)}',
    '.qb-cta-ghost{background:#EDEAE4;color:#0d1b3d}',
