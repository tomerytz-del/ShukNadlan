  ...
  var MARKETS = [
    ...
    },
    {
      ...
      /* חיפה, נשר, טירת כרמל והקריות - מחוף הכרמל ועד קריית אתא - ועד
         קריית טבעון ורכסים בדרום-מזרח. הקצה המזרחי (35.145) נעצר לפני
         התיבה של עפולה והעמק (35.15): חפיפה הייתה נותנת לסדר השורות להחליט. */
      bbox: [32.69, 34.94, 32.89, 35.145],
    ...
    {
      slug: 'nazareth-nof-hagalil',
      label: 'נצרת ונוף הגליל',
      city: 'נצרת',
      path: '/nazareth-nof-hagalil',
      live: false,
      isDefault: false,
      center: [32.70, 35.30],
      zoom: 13,
      /* נצרת, נוף הגליל ומגדל העמק. נגזר מפיני העסקאות (26.9.2026): נוף
         הגליל 32.688-32.734 / 35.305-35.350, מגדל העמק 32.670-32.692 /
         35.221-35.259; נצרת ביניהן. הדרום (32.665) מעל תל עדשים (32.659),
         המזרח (35.36) לפני כפר תבור (35.416) - שתיהן בעפולה והעמק. */
      bbox: [32.665, 35.215, 32.745, 35.36],
      title: 'שוק נדל״ן | נצרת ונוף הגליל',
      description: 'שוק הנדל״ן של נצרת, נוף הגליל ומגדל העמק - כל הדירות, כל המתווכים, בכתובת אחת. נפתחים בקרוב.'
    }
  ];
