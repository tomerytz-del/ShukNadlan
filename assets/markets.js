...
(function (g) {
  ...
  var MARKETS = [
    ...
    },
    {
      ...
      center: [32.965, 35.09],
      zoom: 12,
      /* עכו, נהריה, שלומי ומטה אשר - מצפון לקריות ועד הגבול. הקצה הדרומי
         (32.895) מעט מעל התיבה של חיפה (32.89), בלי חפיפה. הקצה המזרחי
         (35.22) נעצר לפני כרמיאל, שתהיה שוק משלה: מעלות-תרשיחא וכפר ורדים
         (כ-35.27) מחוץ לתיבה, ומגיעות לכאן כשוק הקרוב (NEAR_KM). */
      bbox: [32.895, 35.04, 33.10, 35.22],
