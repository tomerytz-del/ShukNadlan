...
(function (global) {
  ...
  /* ‏priceMonthly הוא לפני מע"מ, כי כך מחירי B2B מוצגים בישראל וכך נכתב
     ...
     ‏priceNote הוא **שורה אחת** שיושבת מתחת למחיר, ולא שני משפטים: בכרטיס
     צר כל פסיק נוסף הוא שבירת שורה, ומחיר שמתפרק לשלוש שורות מפסיק להיראות
     כמו מחיר. ‏status היא תגית קצרה לצד שם המסלול, ו-tabNote מופיע במתג
     המסלולים במובייל.

     ‏**שדות היתרון הם תוספת, לא חוזה חדש.** מי שקורא את הרשימה (מסך בחירת
     המסלול ב-CRM) עדיין קורא רק ‎text‎ ו-‎on‎; השאר מתעלם בשקט:

       sub   — שורת הערך העסקי מתחת ליתרון. מחליפה סוגריים ארוכים בתוך
               המשפט, שנקראים כהערת שוליים ולא כסיבה לשלם.
       hero  — היתרון שמוכר את המסלול. מוצג כבלוק מודגש בראש הרשימה.
       flag  — התגית שעל בלוק ה-hero.
       icon  — אייקון במקום ה-✓. כרגע 'whatsapp' בלבד.

     סדר הרשימה הוא סדר המכירה: ה-CRM מציג את שלושת הראשונים בלבד. */
  var CATALOG = [
    {
      id: 'free',
      name: 'Pay&GO',
      ...
      features: [
        { text: 'מערכת CRM מלאה — נכסים, לידים, לקוחות ועמלות', on: true,
          sub: 'כל העסק במסך אחד, בלי גיליונות ובלי פתקים.' },
        { text: '10 לידי קונה/שוכר בחודש, ואז ₪20 לליד', on: true,
          sub: 'החיוב הוא רק על פנייה שפתחתם בפועל.' },
    ...
    },
    {
      ...
      priceMonthly: 750,
      vat: true,
      priceNote: 'לחודש + מע״מ · ללא התחייבות',
      status: 'הבחירה המקצועית',
      color: 'pro',
      cta: 'בחירה ב-PROFESSIONAL',
      features: [
        { text: 'לידי קונה/שוכר ללא הגבלה', on: true,
          sub: 'כל פנייה נפתחת בלי לספור, ובלי שיקול תקציב.' },
        { text: 'סוכן עוזר אישי בוואטסאפ', on: true, icon: 'whatsapp',
          sub: 'שולחים הודעה, תמונה או הקלטה — והנכס נכנס למערכת לבד.' },
        { text: 'דוח CMA, מידע תכנוני ומפת מיקום מדויקת', on: true,
          sub: 'נכנסים לפגישת מוכר עם נתוני שוק, לא עם הערכה.' },
    ...
    },
    {
      ...
      cta: 'הצטרפות ל-Elite',
      features: [
        { text: '8 סרטוני וידאו שיווקיים AI בחודש', on: true, hero: true, flag: '🔥 מוביל',
          sub: 'נכס עם סרטון נצפה יותר — וההפקה, הכתוביות והפרסום קורים בלעדיכם.' },
        { text: 'חבילת שדרוג דפי נכס בהדמיות AI', on: true, hero: true, flag: '✨ פרימיום',
          sub: 'דירה ריקה נראית מרוהטת בארבעה סגנונות עיצוב. זה מה שסוגר עסקאות.' },
        { text: 'סוכן עוזר אישי בוואטסאפ', on: true, icon: 'whatsapp',
          sub: 'שולחים הודעה, תמונה או הקלטה — והנכס נכנס למערכת לבד.' },
        { text: 'לידי בעל-נכס ללא עלות — כולם', on: true,
          sub: 'כל מוכר ומשכיר שמשאיר פרטים באזור שלכם, בלי חיוב לליד.' },
        { text: 'לידי קונה/שוכר ללא הגבלה', on: true },
        { text: 'הדמיות AI גם לנכסים מסחריים', on: true },
