...
| המספר של שוק נדל״ן בבלוק הקשר | `data-site-contact` |

השורה האחרונה היא המלכודת: בלוק הקשר מועתק לכל דף חדש, ובלי הסימון כל
לחיצה על המספר שלנו נספרת כפנייה למתווך/ת.
