...
**שני המעברים מתנהגים אחרת, וזה מה שכדאי לזכור:**

| מה קרה | הטריגר יורה? |
|---|---|
| הועלו תמונות לנכס פעיל בפעם הראשונה | **כן** — זהו אירוע פרסום מכוון (ראו למעלה) |
| סוכן/ת שודרג/ה ל-Premium | **לא** — `properties` לא השתנתה, ולכן הנכסים שלו/ה צריכים מילוי לאחור |

השני הוא המלכודת: אחרי שדרוג tier הנכסים הופכים זכאים ונשארים בלי הדמיות
עד שמריצים את `scripts/visualizations_backfill.sh`.
